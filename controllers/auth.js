...
exports.forgotPassword = (req, res) => {
  ...
  User.findOne({ email }, (err, user) => {
    ...
    const emailData = {
      ...
      text: `Please use the following link to reset your password: http://143.198.76.152/reset-password/${token}`,
      html: `<p>Please use the following link to reset your password:</p> <p>http://143.198.76.152/reset-password/${token}</p>`,
    };
